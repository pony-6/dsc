...
var dscmallEvent = {
    ...
    init_service_data: function (data) {
        ...
        dscmallEvent.vueobj.change_service(dscmallKefu.user.store_id, dscmallEvent.vueobj.current_target);

    },
    service_list_chat_data: function (store_id, service_id) {
        // 获取 客服对应聊天记录  只做第一次查询
        if (service_id === '') {
            return;
        }
    ...
    vueapp: function () {
        ...
        this.vueobj = new Vue({
            ...
            methods: {
                change_service: function (store_id, service_id, event) {
                    // 切换商家
                    if (service_id === '') {
                        return;
                    }
                    ...
                    dscmallEvent.service_list_chat_data(store_id, service_id);
                    // 未读数量清零
