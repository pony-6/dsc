...
CREATE TABLE IF NOT EXISTS `dsc_goods` (
  ...
  `bar_code` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `goods_name` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `goods_name_style` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '+',
  `click_count` int(10) unsigned NOT NULL DEFAULT '0',
  `brand_id` smallint(5) unsigned NOT NULL DEFAULT '0',
  `provider_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `goods_number` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  `goods_brief` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `goods_desc` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `desc_mobile` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `goods_thumb` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `goods_img` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `original_img` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `is_real` tinyint(3) unsigned NOT NULL DEFAULT '1',
  `extension_code` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  `bonus_type_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `last_update` int(10) unsigned NOT NULL DEFAULT '0',
  `goods_type` smallint(5) unsigned NOT NULL DEFAULT '0',
  `seller_note` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  `goods_shipai` text COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `pinyin_keyword` text COLLATE utf8mb4_unicode_ci,
  `goods_product_tag` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `goods_tag` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '商品标签',
  `stages` varchar(512) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `stages_rate` decimal(10,2) NOT NULL DEFAULT '0.50',
  `freight` tinyint(1) unsigned NOT NULL DEFAULT '2',
  `shipping_fee` decimal(10,2) NOT NULL DEFAULT '0.00',
  `tid` int(10) unsigned NOT NULL DEFAULT '0',
  `goods_unit` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '个',
  `goods_cause` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `commission_rate` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `from_seller` int(11) NOT NULL DEFAULT '0',
  `user_brand` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '品牌统一使用平台品牌ID异步操作',
  `product_table` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'products',
  ...
  `cloud_goodsname` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `goods_video` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商品视频',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1015 ;
...
CREATE TABLE IF NOT EXISTS `dsc_seller_shopinfo` (
  ...
  `shop_name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '店铺名称',
  `shop_title` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '店铺标题',
  `shop_keyword` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '店铺关键字',
  ...
  `district` int(10) unsigned NOT NULL DEFAULT '0',
  `shop_address` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '详细地址',
  `seller_email` varchar(120) CHARACTER SET latin1 NOT NULL,
  `kf_qq` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '客服qq',
  `kf_ww` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '客服旺旺',
  `meiqia` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kf_type` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `kf_tel` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '客服电话',
  `site_head` varchar(125) CHARACTER SET latin1 NOT NULL,
  `mobile` char(11) CHARACTER SET latin1 NOT NULL,
  `shop_logo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '店铺logo',
  ...
  `notice` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '店铺公告',
  `street_desc` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `shop_header` text COLLATE utf8mb4_unicode_ci COMMENT '店铺头部',
  `shop_color` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '店铺整体色调',
  ...
  `remark` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '网站管理员备注信息',
  `seller_theme` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `win_goods_type` tinyint(3) unsigned NOT NULL DEFAULT '1',
  `store_style` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `shipping_date` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `longitude` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tengxun_key` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `latitude` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kf_appkey` int(11) NOT NULL DEFAULT '0' COMMENT '在线客服appkey',
  `kf_touid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '在线客服账号(旺旺号)',
  `kf_logo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'http://' COMMENT '在线客服头像',
  `kf_welcomeMsg` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '在线客服欢迎信息',
  `kf_secretkey` char(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'appkeySecret',
  `user_menu` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '店铺快捷菜单',
  ...
  `seller_templates` varchar(160) COLLATE utf8mb4_unicode_ci NOT NULL,
  `templates_mode` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `js_appkey` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `js_appsecret` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `print_type` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `kdniao_printer` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `business_practice` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `review_status` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `review_content` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `shop_desc` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '店铺描述',
  `shop_can_comment` int(11) NOT NULL DEFAULT '1' COMMENT '店铺是否可评论：0 否, 1 是',
  `zipcode` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '邮政编码',
  PRIMARY KEY (`id`),
  KEY `ru_id` (`ru_id`),
  KEY `shipping_id` (`shipping_id`)
...
CREATE TABLE IF NOT EXISTS `dsc_touch_page_view` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `ru_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '商家ID',
  `type` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1' COMMENT '店铺或专题',
  ...
  `data` longtext COLLATE utf8mb4_unicode_ci COMMENT '内容',
  `pic` longtext COLLATE utf8mb4_unicode_ci COMMENT '图片',
  `thumb_pic` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '缩略图',
