...
$(function(){
    ...
    Ajax.call('index.php?is_ajax=1&act=check_order','', function(data){
		...
		var seller_return_check_count = data.seller_return_check_count ? data.seller_return_check_count :0;//待审批商家退款订单
...
+parseInt(shop_account)+parseInt(shopinfo_account)+parseInt(seller_return_check_count)+parseInt(seller_account)+parseInt(wait_cash)+parseInt(wait_balance)+parseInt(wait_recharge)+parseInt(seller_apply)+parseInt(advance_date)+parseInt(user_account)+parseInt(user_recharge)+parseInt(user_withdraw)+parseInt(user_vat)+parseInt(user_discuss)+parseInt(snatch)+parseInt(bonus_type)+parseInt(group_by)+parseInt(topic)+parseInt(auction)+parseInt(favourable)+parseInt(presale)+parseInt(package_goods)+parseInt(exchange_goods)+parseInt(coupons)+parseInt(gift_gard)+parseInt(seckill)+parseInt(suppliers)+parseInt(suppliers_goods);
		...
		//商家审核提示
		var shop_total = parseInt(shop_account)+parseInt(shopinfo_account)+parseInt(seller_return_check_count)+parseInt(seller_account)+parseInt(wait_cash)+parseInt(wait_balance)+parseInt(wait_recharge)+parseInt(seller_apply);
		if(shop_total >0){
        ...
        if(total != 0){
			//订单提醒 start
				...
				if(await_ship>=0 && await_ship<100){
					$("*[ectype='orderMsg']").append('<p><a href="javascript:void(0);" data-url="order.php?act=list&serch_type=8" data-param="menushopping|02_order_list" target="workspace" class="message" >待发货订单</a> <span class="tiptool">（<em id="no_paid">'+await_ship+'</em>）</span></p>')
				}else if(await_ship>99){
					$("*[ectype='orderMsg']").append('<p><a href="javascript:void(0);" data-url="order.php?act=list&serch_type=8" data-param="menushopping|02_order_list" target="workspace" class="message" >待发货订单</a><span class="tiptool">（<em id="no_paid">99+</em>）</span></p>')
				}
				//待发货订单 end
			...
			//商家提醒 start
				...
				//待审批商家退款 start
				if(seller_return_check_count >= 0  && seller_return_check_count<100){
					$("*[ectype='sellerMsg']").append('<p><a href="javascript:void(0);" data-url="order.php?act=return_list&seller_list=1&check_status=0" data-param="menushopping|12_back_apply" target="workspace" class="message">待审批商家退款</a> <span class="tiptool">（<em id="seller_return_check_count">'+seller_return_check_count+'</em>）</span></p>')
				}else if(seller_return_check_count > 99){
					$("*[ectype='sellerMsg']").append('<p><a href="javascript:void(0);" data-url="order.php?act=return_list&seller_list=1&check_status=0" data-param="menushopping|12_back_apply" target="workspace" class="message">待审批商家退款</a><span class="tiptool">（<em id="seller_return_check_count">99+</em>）</span></p>')
				}
				//待审核商家提现 end
