...
if ('web' == $env['php']['run_mode']) {
    ...
    if (empty($html_error)) {
        ...
        $html_body_loader .= '<p><span class="bold_text">1 - 下载Swoole Loader</span></p><p>请下载兼容PHP' . $env['php']['version'] . '和' . $env['php']['thread_safety'] . '的Swoole Loader扩展，<a target="_blank" href="http://compiler.swoole-cloud.com/trial/download/">点击直达下载页面</a></p>';
