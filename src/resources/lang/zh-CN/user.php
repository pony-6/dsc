...
// 退换货类型
$_LANG['label_return_type'] = '退换货类型';
$_LANG['return_type'][0] = '维修';
$_LANG['return_type'][1] = '退货';
$_LANG['return_type'][2] = '换货';
$_LANG['return_type'][3] = '退款';
// 退款方式
$_LANG['label_refund_type'] = '退款方式';
$_LANG['refund_type'][1] = '退回到余额';
$_LANG['refund_type'][2] = '线下退款';
$_LANG['refund_type'][3] = '不处理';
$_LANG['refund_type'][6] = '在线原路退款';
//退换货 end
...
$_LANG['order_is_team'] = '[拼团]';
$_LANG['order_is_package'] = '[超值礼包]';
$_LANG['order_is_bargain_buy'] = '[砍价]';
...
$_LANG['user_activation_return'] = '确定激活该退换货订单？';
$_LANG['cancel_return'] = '取消退换货订单';
...
$_LANG['msg_mobile_code_blank'] = '手机验证码不能为空';
...
$_LANG['passport_js']['password_shorter'] = '<i></i>登录密码不能少于 8 个字符。';
...
$_LANG['my_recommended'] = '我的推荐';
$_LANG['invited_friends'] = '已邀请好友';
$_LANG['total_amount'] = '总销售额';
$_LANG['today_total'] = '今日收入';
$_LANG['total_commission'] = '累计佣金';
$_LANG['withdrawal_commission'] = '可提现佣金 ';
$_LANG['download_qrcode'] = '下载二维码';
$_LANG['download_qrcode_strong'] = '您可以将此二维码下载下来发送给朋友，新人好友扫码此二维码并注册';
$_LANG['way_tow'] = '方式二';
$_LANG['url_copy'] = '复制链接';
$_LANG['url_copy_strong'] = '您可以选择复制以下推广链接地址，发送给新人好友注册';
$_LANG['reward_subsidiary'] = '奖励明细';
$_LANG['reward_details'] = '奖励详情';
$_LANG['Registration_incentives'] = '注册奖励';
$_LANG['sales_bonus'] = '销售奖励';
$_LANG['card_rewards'] = '推荐办卡奖励';
$_LANG['user_info'] = '用户信息';
$_LANG['join_time'] = '加入时间';
$_LANG['to_view'] = '查看';
$_LANG['divided_into_state'][0] = '未分成';
$_LANG['divided_into_state'][1] = '已分成';
$_LANG['goods'] = '商品';
$_LANG['the_unit_price'] = '单价';
$_LANG['show_good_to_you'] = '小计';
$_LANG['commission_ratio'] = '佣金比例';
$_LANG['obtain_commission'] = '获得佣金';
$_LANG['Buy_information'] = '买家信息';
...
$_LANG['notification'] = '消息通知';
$_LANG['affiliate'] = '我的推荐';
$_LANG['drp_affiliate'] = '分销推荐';
...
$_LANG['surplus_withdrawal_not_support'] = '余额提现暂不支持';
$_LANG['pwd_set'] = '密码已设置';
...
$_LANG['user_order_amount'] = "应付金额";
$_LANG['user_money_paid'] = "已付金额";
...
$_LANG['pic_info_one'] = '<p>为了帮助我们更好的解决问题，请您上传图片</p>
                                    <p>按住Ctrl可以多个图片上传</p>
									<p>最多可上传 :pic_count 张图片，每张图片大小不超过5M，支持bmp,gif,jpg,png,jpeg格式文件</p>';
$_LANG['max_return_pictures'] = '最多可上传 :pic_count 张图片';
...
$_LANG['please_change_mobile'] = '该手机号已被注册, 请更换手机号码';
$_LANG['mobile_isbinded'] = '该手机号已被绑定, 请重新填写';
...
$_LANG['bind_mobile_success'] = '绑定手机号成功！';
$_LANG['bind_mobile_fail'] = '绑定手机号失败！';
$_LANG['verify_old_mobile_success'] = '验证已绑定手机号成功！';
$_LANG['msg_rebind_notice'] = '该手机号已被注册，是否重新绑定关联当前帐号?';
$_LANG['msg_rebind_exit_account'] = '如果您希望绑定已有账号，请选择【去绑定】';
$_LANG['msg_account_bound_success'] = '账号绑定成功！';

$_LANG['msg_authoriza_error'] = '授权登录失败';
...
$_LANG['user_not_exist'] = '用户不存在';
$_LANG['user_pass_error'] = '用户名或密码不正确';
$_LANG['ecjia_auth_login_fail'] = 'ECjia App授权登录失败';
$_LANG['user_pass_empty'] = '密码不能为空';
$_LANG['old_pass_empty'] = '旧密码不能为空';
$_LANG['user_pass_same'] = '密码不能与用户名相同';
$_LANG['user_pass_limit'] = '密码必须是8~16位字符并且包含数字、大小写字母组合';
...
// 登录锁定
$_LANG['login_attempts_increment'] = '密码输入错误！再输错 :remaining 次该账号将被锁定 :formatted_decay_minutes ';
$_LANG['login_attempts_lockout'] = '该账号已锁定，请 :formatted_add_minutes 重试';

// 社区驿站
$_LANG['community_post_info'] = '社区驿站信息';
$_LANG['post_delivery_code'] = '提货码';
$_LANG['post_address'] = '驿站地址';
$_LANG['label_post_mobile'] = '联系电话';
