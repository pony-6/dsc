...
//退換貨 start
    ...
    'operation_notes_required' => '請填寫操作備註',
    'return_brief_required' => '請填寫原因描述',
    'agree_apply' => '同意申請',
    ...
    'refund_type_notic_six' => '在線原路退款申請失敗',

    'return_sn_required' => '退換貨訂單号不能為空',
    'return_order_not_exists' => '退換貨訂單不存在或已退款',
    'return_order_pay_not_supported' => '訂單支付方式不支持原路退款',
    'return_order_no_pay' => '退換貨訂單未支付或已退款',
    'return_order_pay_not_exists' => '退換貨訂單支付方式不存在',
    'return_order_no_pay_log' => '退換貨訂單交易記錄不存在',
    'cert_file_not_exists' => '證書未配置',
    ...
    'average_coupons' => "均攤優惠券金額：%s",
    'average_bonus' => "均攤紅包金額：%s",
    'order_team_ok' => "【拼團訂單】已成團，已拼人數：%s",
    'order_team_false' => "【拼團訂單】未成團，已拼人數：%s，差團人數：%s",
    'order_count' => '更新主訂單子的訂單數量',
    'update_shop_id' => '更新訂單商家ID',

    // excel批量一键發貨
    'order_delivery_download' => '導出訂單商品詳單',
    'order_delivery_download_notic' => '編號ID,訂單號,商品名稱,商品貨號,商品規格,商品結算價格,商品數量,結算價小計,買家備註,商家名稱,下單會員,下單時間,付款時間,收貨人,聯繫電話,收貨地址,確認狀態,付款狀態,發貨狀態,訂單來源,支付方式,訂單號,商品數量,物流公司,物流運單號,已發貨數量,發貨數量',
    'order_delivery_import' => 'Excel批量導入發貨',
    'order_delivery_import_tips' => [
        '先導出待發貨訂單Excel，然后填寫運單號与發貨數量，点击上傳文件即可; Excel每一行对应訂單下的訂單商品，運單號与發貨數量，填寫即生成發貨單并發貨，否则不生成發貨單',
        '1. 訂單中填寫了運單號，并且運單號一致，發貨數量与订购數量一致，訂單即生成一个發貨單并爲已發貨状态',
        '2. 訂單中部分商品填寫運單號，或填寫了但是發貨數量小於订购數量，将按实际發貨數量生成發貨單，并且訂單状态修改爲部分發貨状态',
    ],
    'upload_file' => '上傳文件',
    'upload_file_notic' => '上傳待發貨訂單商品详單Excel文件 格式：xls',
    'please_upload_excel' => '請上傳文件',
    'not_file_type' => '上傳文件类型不支持，請重新上傳',
    'order_delivery_import_batch' => '批量導入發貨',
    'order_goods_import_empty' => '無符合条件訂單更新',
    'sending_number_invoice_no_empty' => '發貨數量 且 物流單號、物流公司 不能爲空',
    'develop_order_status_format' => '%s 訂單状态：%s,%s',
    'delivery_invoice_no_empty' => '%s 運單號爲空',
    'delivery_status_info_empty' => '發貨單號爲空',
    'delivery_status_virtual_goods_stockout' => '虛擬卡缺貨',
	// 新增訂單导出 sty
    // 訂單状态
	...
	// 新增訂單导出 end
    'order_id_is_empty' => '訂單號不能爲空',
    'return_card_record' => '退款訂單號：%s',
];
