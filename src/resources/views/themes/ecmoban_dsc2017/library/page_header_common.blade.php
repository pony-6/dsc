...
@endif
        ...
        <div class="dsc-search">
            <div class="form">
                <form id="searchForm" name="searchForm" method="post" action="{{ url('search.php') }}" onSubmit="return checkSearchForm(this)" class="search-form">
...
@if(!(($filename == 'merchants_store' && $licence_type != 1) || $snapshot ))
