<div class="ecsc-icon">
    ...
    <a target="_blank" href="wholesale_flow.php">{{ $lang['cat_list'] }}</a>
</div>
...
@endforeach
    ...
    <div class="ecscmb">
        ...
        <a href="wholesale_flow.php" target="_blank" class="ecsc-cart">{{ $lang['go_to_cart'] }} <i class="ecsc-right">></i></a>
    </div>
</div>
...
{
Ajax.call('delete_wholesale_cart_goods.php', 'id='+rec_id, deleteCartGoodsResponse, 'POST', 'JSON');
}
