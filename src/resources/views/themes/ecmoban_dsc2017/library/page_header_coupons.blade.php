...
">
        ...
        <div class="nav-main" id="nav">
            <ul class="navitems">
            	<li><a href="coupons.php?act=coupons_index"
@if(request()->get('act')=="coupons_index")
class="curr"
@endif
>{{ $lang['home'] }}</a></li>
                <li><a href="coupons.php?act=coupons_list"
@if(request()->get('act')=="coupons_list")
class="curr"
@endif
>{{ $lang['Good_coupon_market'] }}</a></li>
                <li><a href="coupons.php?act=coupons_goods"
@if(request()->get('act')=="coupons_goods")
class="curr"
@endif
>{{ $lang['task_mart'] }}</a></li>
            </ul>
