...
@endforeach
                    ...
                    <input type="hidden" name="ec_shop_categoryMain" value="{{ $title['parentType']['shop_categoryMain'] }}" id="shop_categoryMain_id_val" />
                </div>
...
@endforeach
                                    ...
                                    <input type="hidden" name="addCategoryMain" value="{{ $title['parentType']['shop_categoryMain'] }}" id="addCategoryMain_Id_val" />
                                </div>
                            </div>
                        </div>
                        <div class="mod_list">
