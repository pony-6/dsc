...
@if($action == 'sales_reward_detail')
        ...
        <div class="user-mod">
            ...
            <div class="affiliate-step-warp clearfix">
                ...
                <div class="user-order-listone">
                    <dl class="item-on">
                        <dt class="item-t-qb">
                            ...
                            <div class="t-info">
                                <span class="info-item">{{ $lang['order_number'] }}：{{ $order_info['order_sn'] }}</span>
                            </div>
                            <div class="t-price">
                            {{ $lang['obtain_commission'] }}：<span class="totalvalue">{{ $order_info['money_format'] }}</span>
                ...
                <div class="pt10 pb10">
                    <a href="index.php" class="user-shop-linkone">{{ $order_info['shop_name'] }}</a>
                </div>
                ...
                <table class="user-table user-table-detail-goods">
                    ...
                    <thead>
                        <tr>
                            <th width="50%">{{ $lang['goods'] }}</th>
                            <th width="30%" class="tl">{{ $lang['the_unit_price'] }}</th>
                            <th width="20%" class="tl">{{ $lang['subtotal'] }}</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
...
@foreach($order_info['goods'] as $val)
...
@endif
                            ...
                            <td><p>{{ $val['goods_price'] }}</p><p> x {{ $val['goods_number'] }}</p></td>
...
@endforeach
                ...
                <div class="user-order-detail-total">
                    <dl class="total-row">
                        <dt class="total-label">{{ $lang['commission_ratio'] }}： </dt>
                        <dd class="total-value">{{ $order_info['level_per'] }}</dd>
                    </dl>
                </div>
...
class="active"
@endif
><a href="user_message.php?act=comment_list">{{ $lang['stay_evaluate_goods'] }}({{ $signNum0 }})</a></li>
                    <li
@if($sign == 1)
class="active"
@endif
><a href="user_message.php?act=comment_list&sign=1">{{ $lang['stay_add_file'] }}({{ $signNum1 }})</a></li>
                    <li
@if($sign == 2)
class="active"
@endif
><a href="user_message.php?act=comment_list&sign=2">{{ $lang['Already_evaluated'] }}({{ $signNum2 }})</a></li>
                </ul>
            </div>
...
@endif
                        ...
                        <div class="t-info">
                            ...
                            <span class="info-item">{{ $item['add_time'] }}</span>
                            <span class="info-item"></span>
                        </div>
                        <div class="t-price">{{ $item['goods_price'] }}</div>
                        </dt>
                        <dd class="item-c">
                            <div class="c-left">
                                <div class="c-goods">
...
@endif
                            ...
                            <div class="c-handle">
                                <a href="javascript:void(0);" class="sc-btn" ectype="btn-comment" data-foot="
@if($item['comment']['comment_id'] > 0 && $item['comment']['img_list'])
false
@else
true
@endif
" data-recid="{{ $item['rec_id'] }}" data-sign="{{ $sign }}">
@if($sign == 0)
{{ $lang['Click_review'] }}
@elseif ($sign == 1)
{{ $lang['Continue_bask_single'] }}
@elseif($sign == 2)
{{ $lang['comment_see'] }}
@endif
</a>
...
@if(request()->get('sign') == 0)
                                ...
                                <h3>{!! insert_get_page_no_records(['filename' => $filename, 'act' => 'comment_list_0']) !!}</h3>
                                <div class="no_btn"><a href="index.php" class="sc-btn">{{ $lang['goto_mall'] }}</a></div>

@elseif (request()->get('sign') == 1)

                                <h3>{!! insert_get_page_no_records(['filename' => $filename, 'act' => 'comment_list_1']) !!}</h3>
                                <div class="no_btn"><a href="user_message.php?act=comment_list" class="sc-btn">{{ $lang['all_comment_list'] }}</a></div>

@elseif (request()->get('sign') == 2)

                                <h3>{!! insert_get_page_no_records(['filename' => $filename, 'act' => 'comment_list_2']) !!}</h3>
                                <div class="no_btn"><a href="user_message.php?act=comment_list" class="sc-btn">{{ $lang['all_comment_list'] }}</a></div>
...
@if($shop_info['ru_id'] > 0)

                <div class="votelist">
                    <div class="title">{{ $lang['Satisfaction_evaluation'] }}</div>
                    <div class="votelist-content">
                        <div class="service-lcol">
                            <div class="service-lcol-cont">
                                <div class="shopper-img"><a href="{{ $merch_cmt['store_url'] }}"><img width="100" height="100" src="{{ $shop_info['logo_thumb'] }}" alt=""></a></div>
                                <div class="shopper-info">
                                    <div class="shopper-msg">
                                        <h3>{{ $shop_info['shop_name'] }}
...
@endif
                                    ...
                                    <div class="shopper-name">
                                        <div class="item">
                                            <strong>{{ $lang['synthesize'] }}</strong>
                                            <span>{{ $merch_cmt['cmt']['all_zconments']['score'] }}</span>
                                        </div>
                                        <div class="item">
                                            <span>{{ $lang['goods'] }}</span>
                                            <span>{{ $merch_cmt['cmt']['commentRank']['zconments']['score'] }}</span>
                                        </div>
                                        <div class="item">
                                            <span>{{ $lang['service'] }}</span>
                                            <span>{{ $merch_cmt['cmt']['commentServer']['zconments']['score'] }}</span>
                                        </div>
                                        <div class="item">
                                            <span>{{ $lang['deliver_goods'] }}</span>
                                            <span>{{ $merch_cmt['cmt']['commentDelivery']['zconments']['score'] }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="score">
                            <dl class="ev-list">
                                ...
                                <dd ectype="rates">
                                    ...
                                    <span class="comt-error" style="display: none;">{{ $lang['Please_rate'] }}</span>
                                </dd>
                            </dl>
                            <dl class="ev-list">
                                <dt><em>*</em>{{ $lang['seller_fwtd'] }}</dt>
                                <dd ectype="rates">
                                    <span class="commstar" ectype="p_rate">
                                        <a href="javascript:;" data-value="1" class="star1"></a>
                                        <a href="javascript:;" data-value="2" class="star2"></a>
                            ...
                            <dl class="ev-list">
                                <dt><em>*</em>{{ $lang['logistics_speed'] }}</dt>
                                <dd ectype="rates">
                                    <span class="commstar" ectype="p_rate">
                                        <a href="javascript:;" data-value="1" class="star1"></a>
                                        <a href="javascript:;" data-value="2" class="star2"></a>
                            ...
                            <dl class="ev-list">
                                <dt><em>*</em>{{ $lang['logistics_senders'] }}</dt>
                                <dd ectype="rates">
                                    <span class="commstar" ectype="p_rate">
                                        <a href="javascript:;" data-value="1" class="star1"></a>
                                        <a href="javascript:;" data-value="2" class="star2"></a>
                            ...
                            <div class="op-btn"><a href="javascript:void(0);" class="sc-btn sc-redBg-btn" ectype="storeRateBtn" data-orderid="{{ $order_id }}">{{ $lang['submit_goods'] }}</a></div>
                        </div>

@else

                        <h3><s class="icon-02"></s><span>{{ $lang['comments_think'] }}</span></h3>
