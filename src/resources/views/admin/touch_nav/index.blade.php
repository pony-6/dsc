...
<div class="warpper">
    ...
    <div class="content">
        ...
        <div class="tabs_info mt10">
            <ul>
                <li class="curr"><a href="{{ route('admin/touch_nav/index', ['device' => $device]) }}">{{ __('admin/touch_nav.touch_nav_list') }}</a></li>
                <li class="  "><a href="{{ route('admin/touch_nav/nav_parent', ['device' => $device]) }}">{{ __('admin/touch_nav.touch_nav_parent') }}</a></li>
            </ul>
        </div>
        ...
        <div class="flexilist">
            <div class="common-head">
                <div class="fl">
                    <a href="{{ route('admin/touch_nav/edit', ['device' => $device, 'parent_id' => $parent_id]) }}" class="btn_trash">
                        <div class="fbutton"><div class="add "><span><i class="fa fa-plus"></i>{{ __('admin/touch_nav.add_touch_nav') }}</span></div></div>
                    </a>
                </div>
                ...
                <div class="search">
                    ...
                    <div class="input">
                        @csrf
                        <input type="text" name="keywords" class="text nofocus" value="{{ $filter['keywords'] ?? '' }}" placeholder="{{ __('admin/touch_nav.search_name') }}" autocomplete="off">
            ...
            <div class="common-content">
                <div class="list-div" id="listDiv">
                    ...
                    @include('admin.touch_nav.library.touch_nav_query')
